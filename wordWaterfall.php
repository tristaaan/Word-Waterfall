<?php
/* Tristan Wright, cs345
 * Word counter and histogram
 * v1: basic numeric output, no histogram
 * v2: added csv output export, hash tag histograms, properly indented
 * v3: added svg word cloud export, cleaned up code.
 */
...
class freq_dictionary
{
  ...
  public function wordsToAdd($words, $which)
  {
    ...
    //add words to Restricted dictionary
    if($which == 1)
      {
    ...
    //add words to the Count dictionary
    else if ($which == 2)
      {
